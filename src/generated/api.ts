...
/**
 * Универсальный ответ bulk-эндпоинтов. Поле `created`/`updated` зависит от операции. В `results` — массив элементов с индексом и либо `id` (успех), либо `error` (отказ). 
 */
...
export interface BulkResultData {
    ...
    'updated'?: number | null;
    'failed'?: number;
    'results'?: Array<BulkResultDataResultsInner>;
}
export interface BulkResultDataResultsInner {
    'index'?: number;
    'id'?: number | null;
    'error'?: string | null;
    'message'?: string | null;
...
export interface ContactsBulkCreateRequest {
    'contacts': Array<ContactWritable>;
}
export interface ContactsBulkUpdateRequest {
    'updates': Array<ContactsBulkUpdateRequestUpdatesInner>;
}
export interface ContactsBulkUpdateRequestUpdatesInner {
    'id': number;
    'fields': ContactWritable;
}
...
export interface MessagesBulkSend200Response {
    'success'?: boolean;
    'data'?: MessagesBulkSend200ResponseData;
}
export interface MessagesBulkSend200ResponseData {
    'sent'?: number;
    'failed'?: number;
    'results'?: Array<MessagesBulkSend200ResponseDataResultsInner>;
}
export interface MessagesBulkSend200ResponseDataResultsInner {
    'index'?: number;
...
export interface MessagesBulkSendRequest {
    'messages': Array<MessagesBulkSendRequestMessagesInner>;
}
export interface MessagesBulkSendRequestMessagesInner {
    'contact_id': number;
    'channel'?: string;
    'content': string;
    'attachments'?: Array<MessagesBulkSendRequestMessagesInnerAttachmentsInner>;
}
export interface MessagesBulkSendRequestMessagesInnerAttachmentsInner {
    'type'?: string;
    'url'?: string;
    'name'?: string;
}
...
export interface SuccessWithMetaMeta {
    ...
    'total'?: number;
    /**
     * v1.1+. В cursor-режиме — токен для следующей страницы. null = последняя страница. В page-режиме отсутствует.
     */
    'next_cursor'?: string | null;
    /**
     * v1.1+. true если есть ещё страницы (cursor-режим).
     */
    'has_more'?: boolean;
}
...
export const ChatsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [cursor] v1.1+. Opaque cursor для постраничной выборки. Если передан — параметры &#x60;page&#x60;/&#x60;per_page&#x60; игнорируются. Получите следующий cursor из &#x60;meta.next_cursor&#x60; предыдущего ответа. &#x60;null&#x60;/отсутствие &#x60;next_cursor&#x60; &#x3D; последняя страница. 
         * @param {number} [limit] v1.1+. Размер cursor-страницы. Используется только в cursor-режиме (&#x60;?cursor&#x3D;...&#x60;); для классической page-пагинации применяется &#x60;per_page&#x60;. 
         ...
         * @throws {RequiredError}
         */
        chatsList: async (page?: number, perPage?: number, cursor?: string, limit?: number, status?: ChatsListStatusEnum, channel?: string, contactId?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        chatsMessages: async (id: number, page?: number, perPage?: number, cursor?: string, limit?: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ChatsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async chatsList(page?: number, perPage?: number, cursor?: string, limit?: number, status?: ChatsListStatusEnum, channel?: string, contactId?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChatsList200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.chatsList(page, perPage, cursor, limit, status, channel, contactId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async chatsMessages(id: number, page?: number, perPage?: number, cursor?: string, limit?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MessagesList200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.chatsMessages(id, page, perPage, cursor, limit, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ChatsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        chatsList(requestParameters: ChatsApiChatsListRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ChatsList200Response> {
            return localVarFp.chatsList(requestParameters.page, requestParameters.perPage, requestParameters.cursor, requestParameters.limit, requestParameters.status, requestParameters.channel, requestParameters.contactId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Сообщения внутри чата
        ...
        chatsMessages(requestParameters: ChatsApiChatsMessagesRequest, options?: RawAxiosRequestConfig): AxiosPromise<MessagesList200Response> {
            return localVarFp.chatsMessages(requestParameters.id, requestParameters.page, requestParameters.perPage, requestParameters.cursor, requestParameters.limit, options).then((request) => request(axios, basePath));
        },
    };
};
...
export interface ChatsApiChatsListRequest {
    ...
    /**
     * v1.1+. Opaque cursor для постраничной выборки. Если передан — параметры &#x60;page&#x60;/&#x60;per_page&#x60; игнорируются. Получите следующий cursor из &#x60;meta.next_cursor&#x60; предыдущего ответа. &#x60;null&#x60;/отсутствие &#x60;next_cursor&#x60; &#x3D; последняя страница. 
     */
    readonly cursor?: string

    /**
     * v1.1+. Размер cursor-страницы. Используется только в cursor-режиме (&#x60;?cursor&#x3D;...&#x60;); для классической page-пагинации применяется &#x60;per_page&#x60;. 
     */
...
export class ChatsApi extends BaseAPI implements ChatsApiInterface {
    ...
    public chatsList(requestParameters: ChatsApiChatsListRequest = {}, options?: RawAxiosRequestConfig) {
        return ChatsApiFp(this.configuration).chatsList(requestParameters.page, requestParameters.perPage, requestParameters.cursor, requestParameters.limit, requestParameters.status, requestParameters.channel, requestParameters.contactId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public chatsMessages(requestParameters: ChatsApiChatsMessagesRequest, options?: RawAxiosRequestConfig) {
        return ChatsApiFp(this.configuration).chatsMessages(requestParameters.id, requestParameters.page, requestParameters.perPage, requestParameters.cursor, requestParameters.limit, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const ContactsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Массовое создание контактов (v1.1)
         * @param {ContactsBulkCreateRequest} contactsBulkCreateRequest 
         * @param {string} [idempotencyKey] Уникальный токен запроса для защиты от дублей при сетевых сбоях. Рекомендация — UUID v4 на каждую логическую операцию. **TTL ключа — 24 часа.** После истечения тот же &#x60;Idempotency-Key&#x60; создаст новую операцию, кешированный результат не возвращается. Повтор в окне 24 часов вернёт сохранённый ответ + заголовок &#x60;Idempotent-Replayed: 1&#x60;. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        contactsBulkCreate: async (contactsBulkCreateRequest: ContactsBulkCreateRequest, idempotencyKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'contactsBulkCreateRequest' is not null or undefined
            assertParamExists('contactsBulkCreate', 'contactsBulkCreateRequest', contactsBulkCreateRequest)
            const localVarPath = `/public/v1/contacts/bulk-create`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(contactsBulkCreateRequest, localVarRequestOptions, configuration)
         ...
         * @summary Массовое обновление контактов (v1.1)
         * @param {ContactsBulkUpdateRequest} contactsBulkUpdateRequest 
         * @param {string} [idempotencyKey] Уникальный токен запроса для защиты от дублей при сетевых сбоях. Рекомендация — UUID v4 на каждую логическую операцию. **TTL ключа — 24 часа.** После истечения тот же &#x60;Idempotency-Key&#x60; создаст новую операцию, кешированный результат не возвращается. Повтор в окне 24 часов вернёт сохранённый ответ + заголовок &#x60;Idempotent-Replayed: 1&#x60;. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        contactsBulkUpdate: async (contactsBulkUpdateRequest: ContactsBulkUpdateRequest, idempotencyKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'contactsBulkUpdateRequest' is not null or undefined
            assertParamExists('contactsBulkUpdate', 'contactsBulkUpdateRequest', contactsBulkUpdateRequest)
            const localVarPath = `/public/v1/contacts/bulk-update`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(contactsBulkUpdateRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        contactsList: async (page?: number, perPage?: number, cursor?: string, limit?: number, tag?: string, channel?: ContactsListChannelEnum, leadStatus?: ContactsListLeadStatusEnum, since?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/public/v1/contacts`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ContactsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async contactsBulkCreate(contactsBulkCreateRequest: ContactsBulkCreateRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.contactsBulkCreate(contactsBulkCreateRequest, idempotencyKey, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ContactsApi.contactsBulkCreate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Обновляет до 100 контактов одним запросом. Каждый item — `{id, fields:{...}}`. Частичный успех допустим. Поддерживает `Idempotency-Key`. 
         ...
         * @throws {RequiredError}
         */
        async contactsBulkUpdate(contactsBulkUpdateRequest: ContactsBulkUpdateRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BulkResult>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.contactsBulkUpdate(contactsBulkUpdateRequest, idempotencyKey, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ContactsApi.contactsBulkUpdate']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async contactsList(page?: number, perPage?: number, cursor?: string, limit?: number, tag?: string, channel?: ContactsListChannelEnum, leadStatus?: ContactsListLeadStatusEnum, since?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContactsList200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.contactsList(page, perPage, cursor, limit, tag, channel, leadStatus, since, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const ContactsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Создаёт до 100 контактов одним запросом. Каждый item — в своей мини-транзакции, частичный успех допустим (см. поля `created`/`failed`/`results`).  Bulk-операция в rate-limit считается как **1 запрос** (а не 100) — это сознательное послабление для поощрения bulk-вызовов.  Поддерживает `Idempotency-Key` (24ч). 
         * @summary Массовое создание контактов (v1.1)
         * @param {ContactsApiContactsBulkCreateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        contactsBulkCreate(requestParameters: ContactsApiContactsBulkCreateRequest, options?: RawAxiosRequestConfig): AxiosPromise<BulkResult> {
            return localVarFp.contactsBulkCreate(requestParameters.contactsBulkCreateRequest, requestParameters.idempotencyKey, options).then((request) => request(axios, basePath));
        },
        /**
         * Обновляет до 100 контактов одним запросом. Каждый item — `{id, fields:{...}}`. Частичный успех допустим. Поддерживает `Idempotency-Key`. 
         * @summary Массовое обновление контактов (v1.1)
         * @param {ContactsApiContactsBulkUpdateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        contactsBulkUpdate(requestParameters: ContactsApiContactsBulkUpdateRequest, options?: RawAxiosRequestConfig): AxiosPromise<BulkResult> {
            return localVarFp.contactsBulkUpdate(requestParameters.contactsBulkUpdateRequest, requestParameters.idempotencyKey, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Создать контакт
        ...
        contactsList(requestParameters: ContactsApiContactsListRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<ContactsList200Response> {
            return localVarFp.contactsList(requestParameters.page, requestParameters.perPage, requestParameters.cursor, requestParameters.limit, requestParameters.tag, requestParameters.channel, requestParameters.leadStatus, requestParameters.since, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Снять тег с контакта
...
/**
 * Request parameters for contactsBulkCreate operation in ContactsApi.
 */
export interface ContactsApiContactsBulkCreateRequest {
    readonly contactsBulkCreateRequest: ContactsBulkCreateRequest

    /**
     * Уникальный токен запроса для защиты от дублей при сетевых сбоях. Рекомендация — UUID v4 на каждую логическую операцию. **TTL ключа — 24 часа.** После истечения тот же &#x60;Idempotency-Key&#x60; создаст новую операцию, кешированный результат не возвращается. Повтор в окне 24 часов вернёт сохранённый ответ + заголовок &#x60;Idempotent-Replayed: 1&#x60;. 
     */
    readonly idempotencyKey?: string
}

/**
 * Request parameters for contactsBulkUpdate operation in ContactsApi.
 */
export interface ContactsApiContactsBulkUpdateRequest {
    readonly contactsBulkUpdateRequest: ContactsBulkUpdateRequest
...
export class ContactsApi extends BaseAPI implements ContactsApiInterface {
     ...
     * @throws {RequiredError}
     */
    public contactsBulkCreate(requestParameters: ContactsApiContactsBulkCreateRequest, options?: RawAxiosRequestConfig) {
        return ContactsApiFp(this.configuration).contactsBulkCreate(requestParameters.contactsBulkCreateRequest, requestParameters.idempotencyKey, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public contactsBulkUpdate(requestParameters: ContactsApiContactsBulkUpdateRequest, options?: RawAxiosRequestConfig) {
        return ContactsApiFp(this.configuration).contactsBulkUpdate(requestParameters.contactsBulkUpdateRequest, requestParameters.idempotencyKey, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public contactsList(requestParameters: ContactsApiContactsListRequest = {}, options?: RawAxiosRequestConfig) {
        return ContactsApiFp(this.configuration).contactsList(requestParameters.page, requestParameters.perPage, requestParameters.cursor, requestParameters.limit, requestParameters.tag, requestParameters.channel, requestParameters.leadStatus, requestParameters.since, options).then((request) => request(this.axios, this.basePath));
    }
...
export const MessagesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Массовая отправка сообщений (v1.1)
         * @param {MessagesBulkSendRequest} messagesBulkSendRequest 
         * @param {string} [idempotencyKey] Уникальный токен запроса для защиты от дублей при сетевых сбоях. Рекомендация — UUID v4 на каждую логическую операцию. **TTL ключа — 24 часа.** После истечения тот же &#x60;Idempotency-Key&#x60; создаст новую операцию, кешированный результат не возвращается. Повтор в окне 24 часов вернёт сохранённый ответ + заголовок &#x60;Idempotent-Replayed: 1&#x60;. 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        messagesBulkSend: async (messagesBulkSendRequest: MessagesBulkSendRequest, idempotencyKey?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'messagesBulkSendRequest' is not null or undefined
            assertParamExists('messagesBulkSend', 'messagesBulkSendRequest', messagesBulkSendRequest)
            const localVarPath = `/public/v1/messages/bulk-send`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(messagesBulkSendRequest, localVarRequestOptions, configuration)
         ...
         * @throws {RequiredError}
         */
        messagesList: async (page?: number, perPage?: number, cursor?: string, limit?: number, contactId?: number, chatId?: number, channel?: string, role?: MessagesListRoleEnum, since?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const MessagesApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async messagesBulkSend(messagesBulkSendRequest: MessagesBulkSendRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MessagesBulkSend200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.messagesBulkSend(messagesBulkSendRequest, idempotencyKey, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MessagesApi.messagesBulkSend']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async messagesList(page?: number, perPage?: number, cursor?: string, limit?: number, contactId?: number, chatId?: number, channel?: string, role?: MessagesListRoleEnum, since?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MessagesList200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.messagesList(page, perPage, cursor, limit, contactId, chatId, channel, role, since, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const MessagesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Отправляет до 50 сообщений одним запросом. Каждое — независимо: частичный успех допустим. Результат каждого item — либо `message_id` (успех), либо `error`.  Per-channel rate-limit (Telegram 30 msg/sec и т.п.) **не обходится** — если канал отвергает сообщение из-за своего лимита, item помечается `DELIVERY_FAILED`.  Поддерживает `Idempotency-Key`. 
         * @summary Массовая отправка сообщений (v1.1)
         * @param {MessagesApiMessagesBulkSendRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        messagesBulkSend(requestParameters: MessagesApiMessagesBulkSendRequest, options?: RawAxiosRequestConfig): AxiosPromise<MessagesBulkSend200Response> {
            return localVarFp.messagesBulkSend(requestParameters.messagesBulkSendRequest, requestParameters.idempotencyKey, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary История сообщений
        ...
        messagesList(requestParameters: MessagesApiMessagesListRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<MessagesList200Response> {
            return localVarFp.messagesList(requestParameters.page, requestParameters.perPage, requestParameters.cursor, requestParameters.limit, requestParameters.contactId, requestParameters.chatId, requestParameters.channel, requestParameters.role, requestParameters.since, options).then((request) => request(axios, basePath));
        },
        /**
         * Реально отправляет сообщение в канал (Telegram/widget/VK) и фиксирует его в истории. Канал выбирается так: 1. явный `channel` в payload (если передан); 2. `last_channel` контакта; 3. иначе 422 `NO_CHANNEL_AVAILABLE`.  Поддерживается заголовок `Idempotency-Key` (стандарт Stripe): повторный запрос с тем же ключом в течение 24 часов вернёт сохранённый ответ без новой отправки. Ответ будет содержать заголовок `Idempotent-Replayed: 1`. 
         * @summary Отправить сообщение
...
/**
 * Request parameters for messagesBulkSend operation in MessagesApi.
 */
export interface MessagesApiMessagesBulkSendRequest {
    readonly messagesBulkSendRequest: MessagesBulkSendRequest
...
export class MessagesApi extends BaseAPI implements MessagesApiInterface {
     ...
     * @throws {RequiredError}
     */
    public messagesBulkSend(requestParameters: MessagesApiMessagesBulkSendRequest, options?: RawAxiosRequestConfig) {
        return MessagesApiFp(this.configuration).messagesBulkSend(requestParameters.messagesBulkSendRequest, requestParameters.idempotencyKey, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public messagesList(requestParameters: MessagesApiMessagesListRequest = {}, options?: RawAxiosRequestConfig) {
        return MessagesApiFp(this.configuration).messagesList(requestParameters.page, requestParameters.perPage, requestParameters.cursor, requestParameters.limit, requestParameters.contactId, requestParameters.chatId, requestParameters.channel, requestParameters.role, requestParameters.since, options).then((request) => request(this.axios, this.basePath));
    }
